...
public:
    ...
    /**
     * Watches the table. This method receives information from the game when the player does not play
     * and can potentially use this information to create a better strategy.
     *
     * This method has an empty implementation here and can be implemented from any derived class of Player.
     *
     * @param table the table of the game, which can be used to check all combinations that are played.
     * @param playerStatuses the statuses of all players as an array of type PlayerStatus.
     * @param numberOfCardsPerPlayer the number of cards of each player as an array of integers.
     */
    virtual void watch(Table* table, PlayerStatus* playerStatuses, int* numberOfCardsPerPlayer){};
...
{
    float aggresiveness;
    vector<pair <Card*,bool> >  CardKnown;
    Node* bestLeaf;
    bool tableCardPlayed[4][13];
    bool tableSpecialPlayed[4];
...
public:
    ...
    /**
     * Watches the table and makes smart decisions. This method receives information from the game when the player does
     * not play and can potentially use this information to create a better strategy.
     *
     * @param table the table of the game, which can be used to check all combinations that are played.
     * @param playerStatuses the statuses of all players as an array of type PlayerStatus.
     * @param numberOfCardsPerPlayer the number of cards of each player as an array of integers.
     */
    void watch(Table* table, PlayerStatus* playerStatuses, int* numberOfCardsPerPlayer);
